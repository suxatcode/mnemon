---
name: mnemon
description: Persistent memory CLI for Hermes Agent. Store facts, recall past knowledge, link related memories (including a teammate's), manage lifecycle.
---
...
3. Link related memories after reviewing candidates from `remember` (on a team
   remote this MAY include another teammate's memory):
