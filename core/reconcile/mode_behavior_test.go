...
func TestConflictModeChangesDecisionDeterministically(t *testing.T) {
	rej := runArmA(t, contract.Modes{Conflict: contract.ConflictReject, Isolation: contract.IsolationWriteCAS, Authz: contract.AuthzPermissive})
	...
	hum := runArmA(t, contract.Modes{Conflict: contract.ConflictDeferToHuman, Isolation: contract.IsolationWriteCAS, Authz: contract.AuthzPermissive})
	...
	am := runArmA(t, contract.Modes{Conflict: contract.ConflictAutoMergeDisjoint, Isolation: contract.IsolationWriteCAS, Authz: contract.AuthzPermissive})
